...
import { REEL_ANALYSIS_TASK_PATH, type SignedReelAnalysisRequest } from './reel-analysis-signing';

export { REEL_ANALYSIS_TRANSPORT_VERSION, REEL_ANALYSIS_TASK_PATH, signingInput, signReelAnalysisRequest, freshMetadata,
  type SignedReelAnalysisRequest } from './reel-analysis-signing';
...
export interface ReelAnalysisEndpoint { readonly hostname: string; readonly port: number; }

export function dispatchReelAnalysisTask(
  ...
  return new Promise((resolve) => {
    ...
    const outgoing = httpRequest({
      host: endpoint.hostname, port: endpoint.port, path: REEL_ANALYSIS_TASK_PATH, method: 'POST', timeout: timeoutMs,
