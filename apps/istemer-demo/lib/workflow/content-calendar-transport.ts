...
import { CONTENT_CALENDAR_TASK_PATH, type SignedContentCalendarRequest } from './content-calendar-signing';

export { CONTENT_CALENDAR_TRANSPORT_VERSION, CONTENT_CALENDAR_TASK_PATH, signingInput, signContentCalendarRequest, freshMetadata,
  type SignedContentCalendarRequest } from './content-calendar-signing';
...
export interface ContentCalendarEndpoint { readonly hostname: string; readonly port: number; }

export function dispatchContentCalendarTask(
  ...
  return new Promise((resolve) => {
    ...
    const outgoing = httpRequest({
      host: endpoint.hostname, port: endpoint.port, path: CONTENT_CALENDAR_TASK_PATH, method: 'POST', timeout: timeoutMs,
